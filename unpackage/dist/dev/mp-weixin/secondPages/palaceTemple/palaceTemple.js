...
const _sfc_main = {
  ...
  onReady() {
    apis_index.getindexGridPalaceTempleAPI().then((res) => {
      const validList = res.message.filter((item) => item.grid);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-37ce0cfa"]]);
_sfc_main.__runtimeHooks = 1;
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/secondPages/palaceTemple/palaceTemple.js.map
